...
public class Submit {
  ...
  public void submit(Integer partId) {
     ...
     * Test on Sample
     */
    String sampleoutput=new CYK().Start("sampleCYK.in");
    System.out.println("**********************\nTest on sample input (sampleCYK.in)......");
    if (!sampleoutput.equals("1 \n02 1 \n1 02 1 \n02 1 02 1 \n13 23 13 23 13 \n"))
    {
    	System.err.println("Your output on sampleCYK.in is not correct");
    	System.err.println("Your generated table X is: "+sampleoutput);
    	System.err.println("Correct table X is: 1 \n02 1 \n1 02 1 \n02 1 02 1 \n13 23 13 23 13 ");
    	System.err.println("0: S, 1: A, 2: B, 3: C");
  ...
  private String challenge_url() {
	    return "http://class.coursera.org/automata-002/assignment/challenge";
  }

  private String submit_url() {
	    return "http://class.coursera.org/automata-002/assignment/submit";
  }


  protected String output(int partId, String ch_aux) {
    String output=new CYK().Start("testCYK.in");
